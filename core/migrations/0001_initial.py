# Generated by Django 2.2 on 2021-02-26 07:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Shirt'), ('SW', 'Sport Wear'), ('OW', 'Outerwear')], max_length=2)),
                ('label', models.CharField(choices=[('P', 'danger'), ('S', 'primary'), ('D', 'secondary')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon_amount', models.CharField(blank=True, max_length=100, null=True)),
